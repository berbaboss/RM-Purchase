...
Create Raw Material Report
    ...
    Input text and Press Enter in ${Time4} with -> ${TimeInput4}
    Double Click in Area with Sikuli and Deleted -> ${Time3} ${Time3}
    Input text and Press Enter in ${Time5} with -> ${TimeInput5}
    Input text and Press Enter in ${ZealNo} with -> ${ZealNoInput}
